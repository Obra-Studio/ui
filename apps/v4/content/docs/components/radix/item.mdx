...
<ComponentPreview styleName="radix-vega" name="item-demo" />
...
<ComponentPreview styleName="radix-vega" name="item-icon" />

### Avatar

You can use `ItemMedia` with `variant="avatar"` to display an avatar.

<ComponentPreview styleName="radix-vega" name="item-avatar" />

### Image

Use `ItemMedia` with `variant="image"` to display an image.

<ComponentPreview styleName="radix-vega" name="item-image" />
...
<ComponentPreview styleName="radix-vega" name="item-link" />
...
<ComponentPreview styleName="radix-vega" name="item-dropdown" />

## RTL

To enable RTL support in shadcn/ui, see the [RTL configuration guide](/docs/rtl).

<ComponentPreview styleName="radix-vega" name="item-rtl" direction="rtl" />
