...
<ComponentPreview styleName="radix-vega" name="tabs-line" />

### Vertical

Use `orientation="vertical"` for vertical tabs.

<ComponentPreview styleName="radix-vega" name="tabs-vertical" />

### Disabled

<ComponentPreview styleName="radix-vega" name="tabs-disabled" />

### Icons

<ComponentPreview styleName="radix-vega" name="tabs-icons" />

## RTL

To enable RTL support in shadcn/ui, see the [RTL configuration guide](/docs/rtl).

<ComponentPreview styleName="radix-vega" name="tabs-rtl" direction="rtl" />
