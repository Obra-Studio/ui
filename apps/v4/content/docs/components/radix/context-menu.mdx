...
<ComponentPreview styleName="radix-vega" name="context-menu-basic" />

### Submenu

Use `ContextMenuSub` to nest secondary actions.

<ComponentPreview styleName="radix-vega" name="context-menu-submenu" />

### Shortcuts

Add `ContextMenuShortcut` to show keyboard hints.

<ComponentPreview styleName="radix-vega" name="context-menu-shortcuts" />

### Groups

Group related actions and separate them with dividers.

<ComponentPreview styleName="radix-vega" name="context-menu-groups" />

### Icons

Combine icons with labels for quick scanning.

<ComponentPreview styleName="radix-vega" name="context-menu-icons" />

### Checkboxes

Use `ContextMenuCheckboxItem` for toggles.

<ComponentPreview styleName="radix-vega" name="context-menu-checkboxes" />

### Radio

Use `ContextMenuRadioItem` for exclusive choices.

<ComponentPreview styleName="radix-vega" name="context-menu-radio" />

### Destructive

Use `variant="destructive"` to style the menu item as destructive.

<ComponentPreview styleName="radix-vega" name="context-menu-destructive" />
