...
<ComponentPreview styleName="radix-vega" name="command-basic" />

### Shortcuts

<ComponentPreview styleName="radix-vega" name="command-shortcuts" />

### Groups

A command menu with groups, icons and separators.

<ComponentPreview styleName="radix-vega" name="command-groups" />

### Scrollable

Scrollable command menu with multiple items.

<ComponentPreview styleName="radix-vega" name="command-scrollable" />
