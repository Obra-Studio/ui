...
<ComponentPreview styleName="base-vega" name="popover-demo" />
...
<ComponentPreview styleName="base-vega" name="popover-basic" />

### Align

Use the `align` prop on `PopoverContent` to control the horizontal alignment.

<ComponentPreview styleName="base-vega" name="popover-alignments" />

### With Form

A popover with form fields inside.

<ComponentPreview styleName="base-vega" name="popover-form" />

## RTL

To enable RTL support in shadcn/ui, see the [RTL configuration guide](/docs/rtl).

<ComponentPreview styleName="base-vega" name="popover-rtl" direction="rtl" />
