...
<ComponentPreview styleName="base-vega" name="tooltip-demo" />
...
<ComponentPreview styleName="base-vega" name="tooltip-sides" />

### With Keyboard Shortcut

<ComponentPreview styleName="base-vega" name="tooltip-keyboard" />

### Disabled Button

Show a tooltip on a disabled button by wrapping it with a span.

<ComponentPreview styleName="base-vega" name="tooltip-disabled" />

## RTL

To enable RTL support in shadcn/ui, see the [RTL configuration guide](/docs/rtl).

<ComponentPreview styleName="base-vega" name="tooltip-rtl" direction="rtl" />
