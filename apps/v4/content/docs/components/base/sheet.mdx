...
<ComponentPreview styleName="base-vega" name="sheet-demo" />
...
<ComponentPreview styleName="base-vega" name="sheet-side" />

### No Close Button

Use `showCloseButton={false}` on `SheetContent` to hide the close button.

<ComponentPreview styleName="base-vega" name="sheet-no-close-button" />

## RTL

To enable RTL support in shadcn/ui, see the [RTL configuration guide](/docs/rtl).

<ComponentPreview styleName="base-vega" name="sheet-rtl" direction="rtl" />
