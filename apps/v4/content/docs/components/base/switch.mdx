...
<ComponentPreview styleName="base-vega" name="switch-demo" />
...
<ComponentPreview styleName="base-vega" name="switch-description" />

### Choice Card

Card-style selection where `FieldLabel` wraps the entire `Field` for a clickable card pattern.

<ComponentPreview styleName="base-vega" name="switch-choice-card" />
...
<ComponentPreview styleName="base-vega" name="switch-disabled" />
...
<ComponentPreview styleName="base-vega" name="switch-invalid" />

### Size

Use the `size` prop to change the size of the switch.

<ComponentPreview styleName="base-vega" name="switch-sizes" />

## RTL

To enable RTL support in shadcn/ui, see the [RTL configuration guide](/docs/rtl).

<ComponentPreview styleName="base-vega" name="switch-rtl" direction="rtl" />
