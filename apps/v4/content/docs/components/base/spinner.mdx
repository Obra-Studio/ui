...
<ComponentPreview styleName="base-vega" name="spinner-demo" />
...
<ComponentPreview styleName="base-vega" name="spinner-custom" />
...
<ComponentPreview styleName="base-vega" name="spinner-size" />
...
<ComponentPreview styleName="base-vega" name="spinner-button" />
...
<ComponentPreview styleName="base-vega" name="spinner-badge" />

### Input Group

<ComponentPreview styleName="base-vega" name="spinner-input-group" />

### Empty

<ComponentPreview styleName="base-vega" name="spinner-empty" />

## RTL

To enable RTL support in shadcn/ui, see the [RTL configuration guide](/docs/rtl).

<ComponentPreview styleName="base-vega" name="spinner-rtl" direction="rtl" />
