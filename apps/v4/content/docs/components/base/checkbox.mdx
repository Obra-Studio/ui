...
<ComponentPreview styleName="base-vega" name="checkbox-invalid" />
...
<ComponentPreview styleName="base-vega" name="checkbox-basic" />

### Description

Use `FieldContent` and `FieldDescription` for helper text.

<ComponentPreview styleName="base-vega" name="checkbox-description" />

### Disabled

Use the `disabled` prop to prevent interaction and add the `data-disabled` attribute to the `<Field>` component for disabled styles.

<ComponentPreview styleName="base-vega" name="checkbox-disabled" />

### Group

Use multiple fields to create a checkbox list.

<ComponentPreview styleName="base-vega" name="checkbox-group" />
