...
<ComponentPreview styleName="base-vega" name="tabs-line" />

### Vertical

Use `orientation="vertical"` for vertical tabs.

<ComponentPreview styleName="base-vega" name="tabs-vertical" />

### Disabled

<ComponentPreview styleName="base-vega" name="tabs-disabled" />

### Icons

<ComponentPreview styleName="base-vega" name="tabs-icons" />

## RTL

To enable RTL support in shadcn/ui, see the [RTL configuration guide](/docs/rtl).

<ComponentPreview styleName="base-vega" name="tabs-rtl" direction="rtl" />
