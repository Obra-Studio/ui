...
<ComponentPreview styleName="base-vega" name="sonner-demo" />
...
<ComponentPreview styleName="base-vega" name="sonner-types" />

### Description

<ComponentPreview styleName="base-vega" name="sonner-description" />

### Position

Use the `position` prop to change the position of the toast.

<ComponentPreview styleName="base-vega" name="sonner-position" />
